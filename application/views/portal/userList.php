     <div class="page-content-wrapper" ng-controller="TraineeListController">
            <!-- BEGIN CONTENT BODY -->
                            ...
                            <div class="table-responsive">    
                                <table class="table table-checkable order-column dataTable no-footer table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <td width="15%"><span ng-bind="UserList.upload_date"></span> 
                                           
                                        </td>
                                        <td width="15%">
<!--                                            <a class="btn btn-link btn-xs" href="javaScript:void(0);" ng-click="EditUsers(UserList.user_id)"><i class="fa fa-pencil-square fa-2x" aria-hidden="true"></i> </a> -->
